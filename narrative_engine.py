...
- Some JSON lists are intentionally capped for large schedules. When fields such as count, total_count, group_count, path_count, shown_count, or omitted_count appear, use the count fields as the total truth and use the shown list only as representative examples.
...
4) Critical Path/Risk
   ...
   - branch_summaries and alternate_tied_paths may be representative/capped examples. Use path_count or alternate_tied_paths_summary.total_count for total branch counts; do not imply the shown examples are the complete branch list.
